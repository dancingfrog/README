...
#### What follows is a brief synopsis of his work:[&ast;](#details)
...
* Designed and implemented the [CORI Data API](https://cori-data-api.ruralinnovation.us/){.external target="_blank"} backend (including GraphQL, Rest, and S3 resources)
